...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (nBestHeight > 0 && nBestHeight < 21)
    {
...
{
    int64_t nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * (25 * CENT); // 25% Forever
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EGAME", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "EGAMEis born on 20-02-2019.";
        CTransaction txNew;
        txNew.nTime = 1562794074;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1562794074;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1223552 : 1223552;
        ...
        assert(block.hashMerkleRoot == uint256("0x9d3d4f73cc3a012ce0b07813c7758b50cadb6b582f5cce772366a148fed1a62d"));
